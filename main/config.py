...
@LastEditTime : 2019-12-30 13:29:29
@Update: 
'''
...
configer.siamrpn.vid.keep_per_frame= 30
configer.siamrpn.vid.pad = lambda w, h: (w + h) / 2,
configer.siamrpn.vid.padval = 0.
...
configer.siamaf.vid.keep_per_frame= 30
configer.siamaf.vid.pad = lambda w, h: (w + h) / 2,
configer.siamaf.vid.padval = 0.
...
configer.siamaf.loss.alpha  = 0.    # 2.
configer.siamaf.loss.beta   = 1.    # 4.
...
configer.siamaf.train.batch_size = 64
